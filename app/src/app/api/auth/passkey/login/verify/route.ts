...
export async function POST(request: NextRequest) {
  ...
  } catch { return NextResponse.json({ error: "Fingerprint verification failed" }, { status: 401 }); }
}
